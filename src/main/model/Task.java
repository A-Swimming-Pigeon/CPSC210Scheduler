...
public class Task extends Todo {
    ...
    public void setProgress(int progress) {
        if (progress < 0 || progress > 100) {
            throw new InvalidProgressException("Invalid progress. Please try something between 0 and 100");
        }
    ...
    public void setEstimatedTimeToComplete(int hours) {
        if (hours < 0) {
            throw new NegativeInputException("Estimated time to complete cannot be less than 0");
        }
        this.etcHours = hours;
    }
